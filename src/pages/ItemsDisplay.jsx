...
const ItemsDisplay = () => {
  const reportedItems = [
  {
    ...
    title: "wallet",
    type: "found",
    description: "Dark brown bifold wallet with the monogram CTD printed on both side",
    photo: "https://media.istockphoto.com/photos/money-wallet-ii-picture-id91599577?k=6&m=91599577&s=612x612&w=0&h=k_F9VXa-93UtI1d1eSaH_eVkKcMrA4mBU2YZ_wmgQlU=",
  ...
  },
  {
    ...
    title: "cat",
    type: "lost",
    description: "Lost short hair domestic cat with a collar. Named 'Clarice' and is very friendly.",
    photo: "https://c.pxhere.com/photos/38/3d/adorable_animal_cat_close_up_cute_feline_kitty_pet-1486829.jpg!d",
  ...
  },
  {
    ...
    title: "keys",
    type: "lost",
    description: "Set of keys with a green keychain and a house-shaped key holder.",
    photo: "https://images.pexels.com/photos/724329/pexels-photo-724329.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940",
